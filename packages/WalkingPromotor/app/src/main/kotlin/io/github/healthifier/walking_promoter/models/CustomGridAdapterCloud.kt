...
class CustomGridAdapterCloud(private val customList: ArrayList<String>, private val customList2: ArrayList<String>) : RecyclerView.Adapter<CustomGridAdapterCloud.CustomViewHolder>(){
    ...
    override fun onBindViewHolder(holder: CustomViewHolder, position: Int) {
        ...
        GlideApp.with(holder.view).load(customList2[position]).thumbnail(0.1f).into(holder.view.imageView)
        // タップしたとき
